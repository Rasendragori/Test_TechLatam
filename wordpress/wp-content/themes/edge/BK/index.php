			...
			<div class="row">
				...
				<div class="col-12 row" style="margin-bottom: 20px;">
					<?php
						...
						$fotorep = new WP_Query( $args2 );
					?>
					<?php if ( $fotorep->have_posts() ) : while ( $fotorep->have_posts() ) : $fotorep->the_post(); ?>
					<!-- post -->
					<div class="col-12 fotoreportaje">
						<h2 class="entry-title">
							<a href="<?php the_permalink(); ?>">
								<?php the_title(); ?>
							</a>
				...
				<div class="col-12 row" style="margin-bottom: 20px;">
					<?php
						...
						$videos_query = new WP_Query( $args3 );
					?>
