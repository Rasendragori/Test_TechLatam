...
$footer_column = $edge_settings['edge_footer_column_section'];
	...
	<div class="widget-wrap">
		<div class="container">
			...
			<?php
				...
				echo '<div class="col -'.$footer_column.'">';
	...
	<?php } ?>
<div class="site-info" <?php if($edge_settings['edge-img-upload-footer-image'] !=''){?>style="background-image:url('<?php echo esc_url($edge_settings['edge-img-upload-footer-image']); ?>');" <?php } ?> style="padding: 0;>
	<div class="container">
	...
	<?php
		...
		dynamic_sidebar( 'edge_footer_options' );
			...
			echo '<div class="copyright" style="padding: 10px 0 10px 0; font-size: 10px;">DERECHOS RESERVADOS ' .'&copy; ' . date('Y') .', UNIVERSIDAD DR. JOSÉ MATÍAS DELGADO / ESCUELA DE CIENCIAS DE LA COMUNICACIÓN - ESTE SITIO IMPLICA LA ACEPTACIÓN DE LAS CONDICIONES GENERALES DE USO'; ?>
			</div>
		<?php endif; ?>
...
<script>
	...
	function showDivs(n) {
	  var i;
	  var x = document.getElementsByClassName("SlidesQS");
