		...
		<?php $disable_entry_format = $edge_settings['edge_entry_format_blog'];
			...
			<?php }
				...
				<div class="row" style="margin-bottom: 20px;">
					<?php
					$post_relacionado = get_post();
					$cat_relacionada = get_the_category( $post_relacionado->ID );
					$query_relacionado = new WP_Query( array(
						'category_name' => $cat_relacionada[0]->slug,
						'posts_per_page' => 3
						) ); ?>
					<?php if ( $query_relacionado->have_posts() ) : while ( $query_relacionado->have_posts() ) : $query_relacionado->the_post(); ?>
					<!-- post -->
					<div class="col-md-4">
						<div class="polaroid_2 row">
							<a href="<?php the_permalink(); ?>" class="image featured col-4 col-md-12">
								<div class="img_post">
									<?php
							...
							<h3 style="font-size: 15px; text-align: center; margin: auto;" class="col-8 col-md-12">
...
<div id="secondary" class="sidebar_principal">
	<div style="margin-bottom: 15px;">
		<h2 class="widgettitle">EN PORTADA</h2>
	</div>
	<div class="row">
		<?php
		$args1 = array(
			...
			$col_portada = new WP_Query( $args1 );
		?>
		<?php if ( $col_portada->have_posts() ) : while ( $col_portada->have_posts() ) : $col_portada->the_post(); ?>
		<!-- post -->
			<div class="col-3 en_portada">
				<a href="<?php the_permalink(); ?>" class="image featured">
					<div class="en_portada_img">
						<?php
							// check if the post has a Post Thumbnail assigned to it.
						if ( has_post_thumbnail() ) {
							the_post_thumbnail('category-thumb');
			...
			<div class="col-9">
				<h2 class="entry-title" style="padding-bottom: 5px;">
					<a href="<?php the_permalink(); ?>">
						<?php the_title(); ?>
					</a>
				</h2>
