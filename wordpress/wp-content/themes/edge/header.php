...
<link rel="stylesheet" type="text/css" href="http://tuespacio.clicknetsystem.com/wp-content/themes/edge/bootstrap-4.0.0/dist/css/bootstrap.min.css">
<script type="text/javascript" src="http://tuespacio.clicknetsystem.com/wp-content/themes/edge/bootstrap-4.0.0/dist/js/bootstrap.min.js" async></script>
		...
		<?php if ( function_exists( 'the_custom_header_markup' ) ) {
			if ( is_header_video_active() && ( has_header_video() || is_customize_preview() ) ) {
				...
				if ( has_header_image() ) {?>
					...
					<img class="imagen-responsive" src="http://tuespacio.clicknetsystem.com/wp-content/uploads/2018/02/cropped-logotuespacio-1.png.png" style="width:50%; position:relative; top: 15px; text-align: center;">
					</a>
					</div>
				<?php }
			}
		...
		<!-- Main Header============================================= -->
				<div id="sticky_header">
					<div class="container clearfix">
						...
						<div class="nav-site-title" style="max-width: 100px">
							<?php
