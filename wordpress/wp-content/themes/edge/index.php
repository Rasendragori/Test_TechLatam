...
get_header('noimage'); ?>
			...
			<div class="row">
				<div class="col-12" style="padding-bottom: 25px;">
					<div id="primary">
						<main id="main" class="site-main clearfix">
							<?php $principal = new WP_Query( 'cat=3&posts_per_page=1' ); ?>
					...
					<!-- post -->
						<div>
							<div class="polaroid">
								...
								?>
								<div>
									<h2 class="entry-title dest_fotorep" style="padding: 15px">
										<a href="<?php the_permalink();?>">
											<?php the_title();?>
										</a>
									</h2>
				...
				<div class="col-12" style="margin-bottom: 20px;">
					<?php echo do_shortcode( "[carousel_slide id='179']" ) ?>
				</div>
				<div class="col-12" style="text-align: center;">
					<h2>VIDEOS</h2>
				</div>
					...
					<!-- post -->
						<div>
							<div class="polaroid" >
								...
								?>
								<div>
									<h2 class="entry-title dest_videos" style="padding: 15px">
										<a href="<?php the_permalink();?>">
											<?php the_title();?>
										</a>
									</h2>
				...
				<div class="col-12" style="margin-bottom: 20px;">
					<?php echo do_shortcode( "[carousel_slide id='173']" ) ?>
				</div>
			</div>
