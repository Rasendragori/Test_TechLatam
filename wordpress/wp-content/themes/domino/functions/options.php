   ...
   array("type"  => "endsub"),
    ...
    array("type" => "startsub",
        ...
        array("name"  => "Posts Layout",
            "id"    => "post_view",
            "desc" => "In <strong>List</strong> layout the Sidebar will appear next to posts on archive pages (Categories, Search results). <br/>In <strong>Grid</strong> layout the posts will appear in 4 columns, without the Sidebar on the right.",
